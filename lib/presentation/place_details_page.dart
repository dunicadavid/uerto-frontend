...
class _PlaceDetailsPageState extends State<PlaceDetailsPage> {
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () {
                                            setState(() {
                                              if (_partySize > 1) {
                                                _partySize--;
                                                StoreProvider.of<AppState>(context).dispatch(const DeletePlaceActivityAvailability());
                                              }
                                            });
                                          },
                                          child: Icon(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: StoreProvider.of<AppState>(context).state.placeActivities!.isNotEmpty
                                          ? ListView.builder(
                                              itemCount:
                                                  StoreProvider.of<AppState>(context).state.placeActivities!.toList().length,
  ...
  void _showDatePicker(int index) {
    showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime.now(), lastDate: DateTime(2024),builder: (BuildContext context, Widget? child) {
      return Theme(
